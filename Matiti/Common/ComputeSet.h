#ifndef MATITI_COMPUTESET_H
#define MATITI_COMPUTESET_H
    ...
    class ComputeSet : public RefCounted {
      ...
      private:
        ...
        ComputeSet& operator=(const ComputeSet&);
         ...
         friend std::ostream& operator<<(std::ostream& out, const Matiti::MaterialSet&);
         friend std::ostream& operator<<(std::ostream& out, const Matiti::MaterialSubset&);

    };  // end class ComputeSet

   std::ostream& operator<<(std::ostream& out, const Matiti::MaterialSet&);
   std::ostream& operator<<(std::ostream& out, const Matiti::MaterialSubset&);
