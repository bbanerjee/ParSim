...
\chapter{General small strain elastic-plastic model}
\section{Preamble}
...
\subsection{Isotropic and Kinematic hardening and porosity evolution rules}
...
\subsection{Temperature increase due to plastic dissipation}
