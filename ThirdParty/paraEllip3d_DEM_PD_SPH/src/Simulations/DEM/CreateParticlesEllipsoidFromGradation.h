#ifndef ELLIP3D_SPHERICAL_PARTICLE_CREATION_H
#define ELLIP3D_SPHERICAL_PARTICLE_CREATION_H

#include <Simulations/Command.h>
#include <ostream>

namespace dem {
class CreateParticlesEllipsoidFromGradation : public Command
{
public:
  ...
  virtual void execute(DiscreteElements* dem, pd::Peridynamics* pd)
  {
    std::cout << "**ERROR** Execute with DEM + PD. "
              << "Should not be called in CreateParticlesEllipsoidFromGradation.\n";
  }
