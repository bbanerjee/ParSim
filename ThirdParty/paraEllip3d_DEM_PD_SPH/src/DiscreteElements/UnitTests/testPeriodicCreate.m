...
function xplusyminus(fig1, fig2)
  axis = [0 0 1];
  angle = -40*pi/180;
  cx = 10.6; cy = -10; cz = 1;
  lx = 1; ly = 2; lz = 3;
...
function xminusyplus(fig1, fig2)
  axis = [0 0 1];
  angle = -20*pi/180;
  cx = -10; cy = 10; cz = 1;
  lx = 1; ly = 2; lz = 3;
...
function xminusyminus(fig1, fig2)
  axis = [0 0 1];
  angle = 20*pi/180;
  cx = -10; cy = -10; cz = 1;
  lx = 1; ly = 2; lz = 3;
...
function drawEllipsoidAlt(cc, ll, ax1, ax2, ax3, fig1)

  [X, Y, Z] = ellipsoid(cc(1), cc(2), cc(3), ll(1), ll(2), ll(3), 20);
