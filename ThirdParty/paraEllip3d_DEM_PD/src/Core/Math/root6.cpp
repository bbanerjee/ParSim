      ...
      std::size_t partID1, std::size_t partID2)
{
  ...
  rtc[0] =
    ...
    8*(a2b1c1*d1e1g1i1 + a1b2c1*d1e1g1i1 + a1b1c2*d1e1g1i1 -
       ...
       a1b1c2*d1f1h1i1 - a1b1c1*d2*f1h1i1 - 0.5*a1*d1e1*e2*f1h1i1 -
       a1b1c1*d1f2h1i1 + a1b1*e1f1*f2h1i1 - a1b1c1*d1f1h2i1) -
    8*a1b1c1*d1e1g1i2 - 8*a1b1c1*d1f1h1i2 -
    8*a1b1d1e1*f1i1*i2 + 32*a1b1c1*d1e1f1j2 -
    16*b2*c1e1*h1i1a1a1 - 16*b1*c2e1*h1i1a1a1 + 16*b1c1*e2*h1i1a1a1 +
    16*b1c1e1*h2i1a1a1 + 16*b1c1e1*h1i2a1a1 -
    16*a2c1*f1g1i1b1b1 - 16*a1c2*f1g1i1b1b1 + 16*a1c1*f2g1i1b1b1 +
    16*a1c1*f1g2i1*b1b1 + 16*a1c1*f1g1i2*b1b1 - 32*c1*i1i2*a1a1*b1b1 +
    16*(-a2b1*d1*g1h1 - a1b2*d1*g1h1 + a1b1*d2*g1h1 + a1b1*d1*g2h1 +
         a1b1*d1*g1h2 - 2*b1*h1h2*a1a1 - 
         2*a1*g1g2*b1b1 + 4*j2*a1a1*b1b1)*c1c1 +
    2*(c2e1f1g1h1 - c1*e2f1g1h1 - c1e1*f2g1h1 + 3*c1e1*f1*g2h1 +
       3*c1e1*f1g1*h2 -
       c1*d2e1g1i1  - 2*b2c1*f1g1i1 + 2*b1c2*f1g1i1 - 2*b1c1*f2g1i1 -
       2*b1c1*f1g2i1 - 
       2*a2*c1e1*h1i1 + 2*a1*c2e1*h1i1 - 2*a1c1*e2*h1i1 - c1d2*f1h1i1 -
       2*a1c1*e1*h2i1 -
       2*b1c1*f1g1i2 - 2*a1c1*e1*h1i2 + 8*a1b1c1*i1i2 +
       4*b1*g1g2*c1c1 + 2*d2*g1h1*c1c1 + 4*a1*h1h2*c1c1 - 16*a1b1*j2*c1c1)*d1d1 +
    2*(-c2e1*g1i1 + c1*e2g1i1 + c1e1*g2i1 - c2*f1h1i1 +
       c1*f2h1i1 + c1*f1*h2i1 + c1e1*g1i2 + c1*f1h1*i2 +
       e1f1*i1i2 - 4*c1e1*f1j2 - 2*g2h1*c1c1 - 2*g1h2*c1c1)*d1d1d1 - 
    2*c1*i1i2*d1d1d1d1 + 4*j2*c1c1*d1d1d1d1 +
    (16*a1b1c1*g1g2 +
     4*a2*c1d1*g1h1 - 4*a1c2*d1*g1h1 - 4*a1c1*d2*g1h1 - 2*a1*e2f1g1h1 - 4*a1c1d1*g2h1 -
     4*a1c1d1*g1h2 -
     2*a1d1*e2g1i1 + 4*a2b1*f1g1i1 - 4*a1b2*f1g1i1 - 4*a1b1*f2g1i1 - 4*a1b1*f1g2i1 +
     2*a2*d1f1h1i1 - 2*a1d2*f1h1i1 - 2*a1*d1f2h1i1 + 6*a1*d1f1h2i1 -
     4*a1b1*f1g1i2 + 6*a1*d1f1h1i2 +
     8*c1*h1h2*a1a1 + 4*e2*h1i1a1a1 + 8*b1*i1i2*a1a1 - 32*b1c1*j2*a1a1 -
     2*c1*g1g2*d1d1 + 2*f2g1i1*d1d1 - 2*f1g2i1*d1d1 - 2*f1g1i2*d1d1 -
     2*a1*i1i2*d1d1 + 8*a1c1*j2*d1d1)*e1e1 +
    (2*d1*f1g1g2 - 2*a2*f1g1h1 + 2*a1*f2g1h1 + 2*a1*f1*g2h1 + 2*a1*f1g1*h2 - 2*a2*d1*g1i1 +
     2*a1d2*g1i1 + 2*a1d1*g2i1 +
     2*a1d1*g1i2 - 8*a1*d1f1*j2 -
     4*h2i1a1a1 - 4*h1i2a1a1)*e1e1e1 - 
    2*a1*g1g2*e1e1e1e1 + 4*j2*a1a1*e1e1e1e1 + 
    2*(2*b2*c1d1*g1h1 - 2*b1c2*d1*g1h1 - 2*b1c1*d2*g1h1 - b1*e1f2g1h1 - 2*b1c1*d1*g2h1 -
       2*b1c1*d1*g1h2 + 8*a1b1c1*h1h2 +
       b2*d1e1g1i1 - b1*d2e1g1i1  - b1*d1e2g1i1 + 3*b1d1e1*g2i1 - 2*a2b1*e1*h1i1 +
       2*a1b2*e1*h1i1 - 2*a1b1*e2*h1i1 - b1*d1f2h1i1 - 2*a1b1*e1*h2i1 +
       3*b1d1e1*g1i2 - 2*a1b1*e1*h1i2 +
       4*c1*g1g2*b1b1 + 2*f2g1i1b1b1 + 4*a1*i1i2*b1b1 - 16*a1c1*j2*b1b1 -
       c1*h1h2*d1d1 + e2*h1i1*d1d1 - e1*h2i1*d1d1 - e1*h1i2*d1d1 -
       b1*i1i2*d1d1 + 4*b1c1*j2*d1d1 -
       b1*g1g2*e1e1 + d2*g1h1*e1e1 - d1*g2h1*e1e1 - d1*g1h2*e1e1 -
       a1*h1h2*e1e1 + 4*a1b1*j2*e1e1 + 2*j2*d1d1*e1e1)*f1f1 +
    2*(-b2*e1*g1h1 + b1*e2g1h1 +
        b1*e1*g2h1 + b1*e1*g1h2 +
        d1e1*h1h2 - b2*d1*h1i1 +
        b1*d2*h1i1 + b1*d1*h2i1 +
        b1*d1*h1i2 - 4*b1d1e1*j2 -
        2*g2i1*b1b1 - 2*g1i2*b1b1)*f1f1f1 - 
    2*b1*h1h2*f1f1f1f1 + 4*j2*b1b1*f1f1f1f1 +
    (-4*b2c1*d1e1*f1 - 4*b1c2*d1e1*f1 + 4*b1c1*d2e1*f1 + 4*b1c1*d1*e2*f1 +
      4*b1c1d1e1*f2 -
      8*c1*f1f2*b1b1 -
      8*b1*d1d2*c1c1 + 16*a2*b1b1*c1c1 -
      2*c1e1*e2*d1d1 + 4*b2*c1c1*d1d1 -
      8*a2b1c1*e1e1 + 2*c1d1*d2*e1e1 + d1*e2*f1*e1e1 + 2*b1*f1f2*e1e1 + c2*d1d1*e1e1 -
      d2*f1*e1e1e1 - d1f2*e1e1e1 + a2*e1e1e1e1 - 
      2*b1*e1e2*f1f1 + 4*c2*b1b1*f1f1 + b2*e1e1*f1f1)*g1g1 +
    (-4*a2c1*d1e1*f1 - 4*a1c2*d1e1*f1 + 4*a1c1*d2e1*f1 + 4*a1c1d1*e2*f1 +
      4*a1c1d1e1*f2 -
      8*c1e1*e2*a1a1 -
      8*a1*d1d2*c1c1 + 16*b2*a1a1*c1c1 -
      2*c1*f1f2*d1d1 + 4*a2*c1c1*d1d1 -
      2*a1*f1f2*e1e1 + 4*c2*a1a1*e1e1 -
      8*a1b2c1*f1f1 + 2*c1d1*d2*f1f1 + 2*a1*e1e2*f1f1 + d1e1*f2*f1f1 +
      c2*d1d1*f1f1 + a2*e1e1*f1f1 -
      d2e1*f1f1f1 - d1*e2*f1f1f1 + b2*f1f1f1f1)*h1h1 +
    (-4*a2b1*d1e1*f1 - 4*a1b2*d1e1*f1 + 4*a1b1*d2e1*f1 + 4*a1b1*d1*e2*f1 +
      4*a1b1d1e1*f2 -
      8*b1*e1e2*a1a1 -
      8*a1*f1f2*b1b1 + 16*c2*a1a1*b1b1 -
      8*a1b1c2*d1d1 + 2*a1*e1e2*d1d1 + d2e1*f1*d1d1 + 2*b1*f1f2*d1d1 -
      e2*f1*d1d1d1 - e1f2*d1d1d1 + c2*d1d1d1d1 - 
      2*a1*d1d2*e1e1 + 4*b2*a1a1*e1e1 + a2*d1d1*e1e1 -
      2*b1*d1d2*f1f1 + 4*a2*b1b1*f1f1 + b2*d1d1*f1f1)*i1i1;

  REAL term11 = -(d2*e1*g1) - d1*e2g1 + 2*b2*f1g1 + 2*b1*f2g1;
  REAL term12 = -d1e1*g2 + 2*b1*f1*g2 + 2*a2*e1*h1 + 2*a1*e2*h1;
  ...
  rtc[1] =
    (-2*c2*d1e1*g1 + 2*c1d1*e2g1 + 4*b1c2*f1g1 - e1e2*f1g1 - 4*b1c1*f2g1 +
      4*a1*c2e1*h1 - 4*a1c1*e2*h1 - 2*c2*d1f1*h1 + 2*c1d1*f2*h1 - e1f1*f2*h1 -
      8*a1b1c2*i1 + 2*a1*e1e2*i1 - d1*e2*f1i1 - d1e1*f2*i1 + 2*b1*f1f2*i1 +
      8*a1b1c1*i2 + 2*d1e1*f1*i2 +
      2*c2*i1*d1d1 - 2*c1*i2*d1d1 +
      f2g1*e1e1 - 2*a1*i2*e1e1 +
      e2*h1*f1f1 - 2*b1*i2*f1f1)*term10 +
    (-8*a2b1c1*g1 + 2*c1d1*d2*g1 - d2e1*f1g1 - d1e1*f2g1 + 2*b1*f1*f2g1 +
      8*a1b1c1*g2 + 2*d1e1*f1*g2 +
      4*a2*c1d1*h1 - 4*a1c1*d2*h1 - 2*a2*e1f1*h1 + 2*a1*e1f2*h1 - d1f1*f2*h1 -
      2*a2*d1e1*i1 + 2*a1d2e1*i1 + 4*a2b1*f1i1 - d1d2*f1i1 - 4*a1b1*f2*i1 -
      2*c1*g2*d1d1 + f2*i1*d1d1 +
      2*a2*g1*e1e1 - 2*a1*g2*e1e1 +
     -2*b1*g2*f1f1 + d2*h1*f1f1)*term20 +
    (-4*b1c1*g1g2 + 2*c1d1*g2h1 - e1f1g2h1 +
      2*c1d1*g1h2 - e1f1g1h2 - 4*a1c1*h1h2 -
      d1e1g2i1 + 2*b1*f1g2i1 + 2*a1*e1*h2i1 - d1f1h2i1 -
      d1e1g1i2 + 2*b1*f1g1i2 + 2*a1*e1*h1i2 - d1f1h1i2 - 4*a1b1*i1i2 +
      16*a1b1c1*j2 + 4*d1e1f1j2 +
      i1i2*d1d1 - 4*c1*j2*d1d1 +
      g1g2*e1e1 - 4*a1*j2*e1e1 +
      h1h2*f1f1 - 4*b1*j2*f1f1)*term30 +
    (4*b2*c1d1*g1 - 4*b1c1*d2*g1 - d1e1*e2g1 - 2*b2*e1f1g1 + 2*b1*e2*f1g1 -
     8*a1b2c1*h1 + 2*c1d1*d2*h1 + 2*a1*e1e2*h1 - d2e1*f1h1 - d1*e2*f1h1 +
     8*a1b1c1*h2 + 2*d1e1*f1*h2 +
     4*a1b2*e1*i1 - d1*d2e1*i1 - 4*a1b1*e2*i1 - 2*b2*d1f1*i1 + 2*b1*d2*f1i1 -
     2*c1*h2*d1d1 + e2*i1*d1d1 +
     d2*g1*e1e1 - 2*a1*h2*e1e1 +
     2*b2*h1*f1f1 - 2*b1*h2*f1f1)*term40;
  ...
  REAL term112 = 2*b2*f1*g2 + 2*b1*f2*g2 + 2*a2*e2*h1 - d2*f2*h1;
  ...
  REAL term132 = 2*e1e2*g2 + 2*c2*d2*h1 - e2*f2*h1 + 2*c2*d1*h2;
  ...
  REAL term181 = 2*c2*d2*g1 - e2*f2g1 + 2*c2*d1*g2 + 2*c1d2*g2;
  REAL term182 = -e2*f1*g2 - e1f2*g2 - 4*a2*c2*h1 - 4*a2c1*h2;
  REAL term183 = -4*a1c2*h2 + 2*f1f2*h2 + 2*a2*e2*i1 - d2*f2*i1;
  REAL term184 = 2*a2*e1*i2 + 2*a1*e2*i2 - d2*f1*i2 - d1f2*i2;
  REAL h1f2f2 = h1*f2f2;
  REAL term180 = term181 + term182 + term183 + term184 + h1f2f2;
  rtc[2] =
    (-2*c2*d1*e1*g1 + 2*c1*d1*e2*g1 + 4*b1*c2*f1*g1 - e1*e2*f1*g1 - 4*b1*c1*f2*g1 + 
      4*a1*c2*e1*h1 - 4*a1*c1*e2*h1 - 2*c2*d1*f1*h1 + 2*c1*d1*f2*h1 - e1*f1*f2*h1 -
      8*a1*b1*c2*i1 + 2*a1*e1*e2*i1 - d1*e2*f1*i1 - d1e1*f2*i1 + 2*b1*f1*f2*i1 +
      8*a1b1c1*i2 + 2*d1e1*f1*i2 +
      2*c2*i1*d1d1 - 2*c1*i2*d1d1 +
      f2g1*e1e1 - 2*a1*i2*e1e1 +
      e2*h1*f1f1 - 2*b1*i2*f1f1)*term110 +
      f2*term150*term20 +
    (-8*a2b1c1*g1 + 2*c1d1*d2*g1 - d2e1*f1g1 - d1e1*f2g1 + 2*b1*f1*f2g1 + 
      8*a1b1c1*g2 + 2*d1e1*f1*g2 +
      4*a2*c1d1*h1 - 4*a1c1*d2*h1 - 2*a2*e1f1*h1 + 2*a1*e1f2*h1 - d1f1*f2*h1 - 
      ...
      2*c1*g2*d1d1 + f2*i1*d1d1 + 
      2*a2*g1*e1e1 - 2*a1*g2*e1e1 -
      2*b1*g2*f1f1 + d2*h1*f1f1)*term130 +
    ...
    (-4*b1c1*g1g2 + 2*c1d1*g2h1 - e1f1g2h1 + 2*c1d1*g1h2 -
      ...
      4*a1*j2*e1e1 + h1h2*f1f1 - 4*b1*j2*f1f1)*term170 +
    (4*b2*c1d1*g1 - 4*b1c1*d2*g1 - d1e1*e2g1 - 2*b2*e1f1g1 +
     ...
     2*b2*h1*f1f1 - 2*b1*h2*f1f1)*term180 +
    c2*term150*term150 +
    a2*term160*term160 +
    j2*term30*term30 +
    b2*term40*term40;

  REAL term211 = -(d2*e2*g2) + 2*b2*f2*g2 + 2*a2*e2*h2 - d2*f2*h2;
  REAL term212 = -4*a2*b2*i2 + i2*d2d2;
  REAL term210 = term211 + term212;
  REAL term231 = -4*b2*c2*g2 + 2*c2*d2*h2 - e2*f2*h2 - d2*e2*i2;
  ...
  REAL term251 = 2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 2*a2*e2*i2 - d2*f2*i2 + h2*f2f2;
  ...
  rtc[3] =
    ...
    (-2*c2*d1e1*g1  + 2*c1d1*e2g1 + 4*b1c2*f1g1 - e1e2*f1g1 -
      ...
      8*a1b1c2*i1 + 2*a1*e1e2*i1 - d1*e2*f1i1 -
      d1e1*f2*i1 + 2*b1*f1f2*i1 + 8*a1b1c1*i2 +
      2*d1e1*f1*i2 + 2*c2*i1*d1d1 - 2*c1*i2*d1d1 +
      f2g1*e1e1 - 2*a1*i2*e1e1 +
      e2*h1*f1f1 - 2*b1*i2*f1f1)*term210 +
    f2*term110*term20 +
    (f2*term150 + 2*a2*term20)*term130 +
    (-8*a2b1c1*g1 + 2*c1d1*d2*g1 - d2e1*f1g1 -
      d1e1*f2g1 + 2*b1*f1*f2g1 + 8*a1b1c1*g2 +
      2*d1e1*f1*g2 + 4*a2*c1d1*h1 - 4*a1c1*d2*h1 -
      2*a2*e1f1*h1 + 2*a1*e1f2*h1 - d1f1*f2*h1 -
      2*a2*d1e1*i1 + 2*a1d2e1*i1 + 4*a2b1*f1i1 -
      d1d2*f1i1 - 4*a1b1*f2*i1 - 2*c1*g2*d1d1 +
      f2*i1*d1d1 + 2*a2*g1*e1e1 - 2*a1*g2*e1e1 - 
      2*b1*g2*f1f1 + d2*h1*f1f1 )*term230 +
    ...
    (-4*b1c1*g1g2 + 2*c1d1*g2h1 - e1f1g2h1 + 2*c1d1*g1h2 -
      ...
      2*a1*e1*h1i2 - d1f1h1i2 - 4*a1b1*i1i2 + 16*a1b1c1*j2 +
      4*d1e1f1j2 + i1i2*d1d1 - 4*c1*j2*d1d1 + g1g2*e1e1 -
      4*a1*j2*e1e1 + h1h2*f1f1 - 4*b1*j2*f1f1)*term240 +
    (e2*term150 + d2*term160 + h2*term30 + 2*b2*term40)*term180 +
    (4*b2*c1d1*g1 - 4*b1c1*d2*g1 - d1e1*e2g1 -
     2*b2*e1f1g1 + 2*b1*e2*f1g1 - 8*a1b2c1*h1 + 2*c1d1*d2*h1 +
     2*a1*e1e2*h1 - d2e1*f1h1 - d1*e2*f1h1 + 8*a1b1c1*h2 +
     2*d1e1*f1*h2 + 4*a1b2*e1*i1 - d1*d2e1*i1 -
     4*a1b1*e2*i1 - 2*b2*d1f1*i1 + 2*b1*d2*f1i1 -
     2*c1*h2*d1d1 + e2*i1*d1d1 + d2*g1*e1e1 - 2*a1*h2*e1e1 +
     2*b2*h1*f1f1 - 2*b1*h2*f1f1)*term251;
  ...
  rtc[5] =
    2*c2*term110*term210 +
    f2*term210*term130 +
    f2*term110*term230 +
    2*a2*term130*term230 +
    i2*term210*term170 +
    g2*term230*term170 +
    i2*term110*term240 +
    g2*term130*term240 +
    2*j2*term170*term240 +
    e2*term210*term180 +
    d2*term230*term180 +
    h2*term240*term180 +
    e2*term110*term251 +
    d2*term130*term251 +
    h2*term170*term251 +
    2*b2*term180*term251;

  rtc[6] = f2*term210*term230 +
           i2*term210*term240 +
           g2*term230*term240 +
           e2*term210*term251 +
           d2*term230*term251 +
  ...
  */
  for (int k = 0; k < nlamda; k++) {
    ...
    det = 8*a1b1c1 + 2*d1e1*f1 - 2*c1*d1d1 -
          2*a1*e1e1 - 2*b1*f1f1 +
          lambda*term30 +
          term170*lambdaSq +
          term240*lambdaCu;
    ...
    if (fabs(det) > EPS) { 
      x = ((-4*b1c1*g1 + 2*c1d1*h1 - e1f1*h1 - d1e1*i1 +
            ...
            term230*lambdaCu)) /
          det;
      y = ((2*c1d1*g1 - e1f1g1 - 4*a1c1*h1 +
            2*a1*e1*i1 - d1f1*i1 + h1*f1f1 +
            lambda*term40 +
            term180*lambdaSq +
            term251*lambdaCu)) /
          det;
      z = ((-(d1e1*g1) + 2*b1*f1g1 + 2*a1*e1*h1 -
            d1f1*h1 - 4*a1b1*i1 + i1*d1d1 +
            lambda*term10 +
            term110*lambdaSq +
            term210*lambdaCu)) /
          det;
