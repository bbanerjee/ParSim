...
REAL**
submatrix(REAL** a, long oldrl, long oldrh, long oldcl, long oldch, long newrl,
          long newcl)
...
REAL**
convert_matrix(REAL* a, long nrl, long nrh, long ncl, long nch)
...
/* allocate a REAL 3tensor with range t[nrl..nrh][ncl..nch][ndl..ndh] */
{
  ...
  /* allocate rows and set pointers to them */
  t[nrl][ncl] =
    (REAL*)malloc((size_t)((nrow * ncol * ndep + NR_END) * sizeof(REAL)));
  if (!t[nrl][ncl])
...
void
free_dvector(REAL* v, long nl, long nh)
...
void
free_matrix(REAL** m, long nrl, long nrh, long ncl, long nch)
...
void
free_dmatrix(REAL** m, long nrl, long nrh, long ncl, long nch)
...
void
free_submatrix(REAL** b, long nrl, long nrh, long ncl, long nch)
...
void
free_convert_matrix(REAL** b, long nrl, long nrh, long ncl, long nch)
...
void
free_f3tensor(REAL*** t, long nrl, long nrh, long ncl, long nch, long ndl,
              long ndh)
