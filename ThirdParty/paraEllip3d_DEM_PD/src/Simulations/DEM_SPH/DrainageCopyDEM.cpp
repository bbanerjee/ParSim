  ...
  {     
    ...
    scatterDEMSPHParticleCopyDEM(); // scatter particles only once; also updates patchGrid for the first time
    calcNeighborRanks();
...
//	gatherParticle();
	gatherSPHParticle();	// particles that are out of patchGrid have been deleted
	gatherBdryContact();
