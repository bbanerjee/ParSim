...
#vertices = matrix(c(-10,-12,-14, 1,  10,-12,-14, 1, 
...
#------------------------------------------------------------------
# Plot my ellipsoids (face)
#------------------------------------------------------------------
ids <- df_part$id
#my.ellipsoids(pos_mat[,c(2,10)], size_mat[,c(2,10)], euler_angles[,c(2,10)], col="gold", add=TRUE, alpha = 1.0)
#texts3d(t(pos_mat)[c(2,10),], adj = c(1.5, 1.5), texts=ids[c(2,10)])
#arrow3d(pos_mat[,2], pos_mat[,10], s = 0.07, width = 0.1, n = 10, type="rotation", col="blue")
#rgl.snapshot("rgl_my_ellipsoids.png")

#------------------------------------------------------------------
# Plot my ellipsoids (edge 1)
#------------------------------------------------------------------
#my.ellipsoids(pos_mat[,c(3,11)], size_mat[,c(3,11)], euler_angles[,c(3,11)], col="gold", add=TRUE, alpha = 1.0)
#texts3d(t(pos_mat)[c(3,11),], adj = c(1.5, 1.5), texts=ids[c(3,11)])
#arrow3d(pos_mat[,3], pos_mat[,11], s = 0.07, width = 0.1, n = 10, type="rotation", col="blue")
#rgl.snapshot("rgl_my_ellipsoids.png")

#------------------------------------------------------------------
# Plot my ellipsoids (edge 2)
#------------------------------------------------------------------
my.ellipsoids(pos_mat[,c(9,14,15,16)], size_mat[,c(9,14,15,16)], euler_angles[,c(9,14,15,16)], col="gold", add=TRUE, alpha = 1.0)
texts3d(t(pos_mat)[c(9,14,15,16),], adj = c(1.5, 1.5), texts=ids[c(9,14,15,16)])
arrow3d(pos_mat[,9], pos_mat[,14], s = 0.07, width = 0.1, n = 10, type="rotation", col="blue")
arrow3d(pos_mat[,9], pos_mat[,15], s = 0.07, width = 0.1, n = 10, type="rotation", col="blue")
arrow3d(pos_mat[,9], pos_mat[,16], s = 0.07, width = 0.1, n = 10, type="rotation", col="blue")
#rgl.snapshot("rgl_my_ellipsoids.png")

#my.ellipsoids(pos_mat[,c(-2,-3,-10,-11)], size_mat[,c(-2,-3,-10,-11)], euler_angles[,c(-2,-3,-10,-11)], col="gold", add=TRUE, alpha = 1.0)
#texts3d(t(pos_mat)[c(-2,-3,-10,-11),], adj = c(1.5, 1.5), texts=ids[c(-2,-3,-10,-11)])
