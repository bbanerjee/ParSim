...
!****************************************************************************
!*																			*
!*	ModuleFile : bond_family_computations									*
...
!*																			*
!****************************************************************************
module bond_family_computations
...
! local variables
      integer(4) :: cell1, cell2
      integer(4) :: bin_loc, bin_loc_start, bin_loc_end
      real(8) :: dist_sq
      real(8) :: dx1_cell, dx2_cell
      integer(4) :: search_lo_1, search_lo_2
      integer(4) :: search_hi_1, search_hi_2
      integer(4) :: search_cell_1, search_cell_2
      integer(4) :: search_node
...
! local variables
      ...
      integer(4) :: bin_loc, bin_loc_start, bin_loc_end
      real(8) :: dist_sq
      real(8) :: dy1_cell, dy2_cell
      integer(4) :: search_lo_1, search_lo_2
      integer(4) :: search_hi_1, search_hi_2
      integer(4) :: search_cell_1, search_cell_2
      integer(4) :: search_node
      integer(4) :: i
      real(8) :: yt1_search_node, yt2_search_node
...
! local variables
      integer(4) :: cell1, cell2
      integer(4) :: nodes_in_last_cell, last_bin, number_of_nodes_in_this_cell
      integer(4) :: m, i
      integer(4) :: bin_loc, bin_loc_start, bin_loc_rel
      real(8) :: range
      real(8) :: dx1_cell, dx2_cell
!	  real(8) :: xt1(nnodes), xt2(nnodes)
      ...
      do m=1,nnodes
        ...
        if( (cell1<1.or.cell1>ncell1) .or. (cell2<1.or.cell2>ncell2) ) then
          ...
          do bin_loc_rel=0,number_of_nodes_in_this_cell-1
            ...
            if(nodes_in_bin(bin_loc).eq.0) then
      ...
      do m=1,nnodes
        ...
        if( (cell1<1.or.cell1>ncell_def1) .or. (cell2<1.or.cell2>ncell_def2) ) then
          ...
          do bin_loc_rel=0,number_of_nodes_in_this_cell-1
            ...
            if(nodes_in_bin_def(bin_loc).eq.0) then
