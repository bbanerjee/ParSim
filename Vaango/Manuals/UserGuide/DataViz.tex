...
\begin{minipage}[b]{\textwidth}
  ...
  launch \Visit and start visualizing UDA's. To open a UDA, select \Textsfc{
  Open File} from the \Textsfc{File} menu. Browse into
  the UDA you want to load and select the \Textsfc{index.xml}
  file. Then hit on \Textsfc{OK} and a list of timesteps should
  ...
  \begin{minipage}[b]{0.35\textwidth}
    \centering
    \includegraphics[width=\textwidth]{VisItFileOpen.png}
    \captionof{figure}{Opening an UDA with \Visit}
    \label{VisItFileOpen}
  \end{minipage}
\end{minipage}
