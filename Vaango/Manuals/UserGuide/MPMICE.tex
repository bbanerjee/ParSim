...
\begin{figure}
  \center
  \includegraphics[width=0.5\textwidth]{M2wedge.png}
...
\begin{figure}
  \center
  \includegraphics[width=0.5\textwidth]{cylCrossFlow.png}
...
\begin{figure}
  \center
  \includegraphics[width=0.5\textwidth]{QM100.png}
...
% \begin{figure}
%   \center
%   \includegraphics[width=0.5\textwidth]{SimpleBurn0000.png}
...
% \begin{figure}
%   \center
%   \includegraphics[width=0.5\textwidth]{SimpleBurn0001.png}
...
% \begin{figure}
%   \center
%   \includegraphics[width=0.5\textwidth]{SimpleBurn0002.png}
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[width=\textwidth]{SimpleBurn0000.png}
    \caption{Receding PBX9501 leads to pressure increase in cylindrical steel shell}
    \label{figsimburn1}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[width=\textwidth]{SimpleBurn0001.png}
    \caption{Pressure increase causes cylinder to respond}
    \label{figsimburn2}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[width=\textwidth]{SimpleBurn0002.png}
    \caption{The left half of the image represents particles as spheres colored according to mass and pressure as background color.  Top-right shows delP\_Dilatate and bottom-right shows delP\_MassX}
    \label{figsimburn3}
  \end{subfigure}
  \caption{}
...
% \begin{figure}
%   \center
%   \includegraphics[width=0.5\textwidth]{SteadyBurn0000.png}
...
% \begin{figure}
%   \center
%   \includegraphics[width=0.5\textwidth]{SteadyBurn0001.png}
...
% \begin{figure}
%   \center
%   \includegraphics[width=0.5\textwidth]{SteadyBurn0002.png}
...
\begin{figure}
  \centering
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[width=\textwidth]{SteadyBurn0000.png}
    \caption{Collapse of PBX into hollow bore of explosive device}
    \label{figsteadyburn1}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[width=\textwidth]{SteadyBurn0001.png}
    \caption{Expansion of steel casing as explosion occurs--response to pressure build-up}
    \label{figsteadyburn2}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[width=\textwidth]{SteadyBurn0002.png}
    \caption{Burning Cells denoted by red squares}
    \label{figsteadyburn3}
  \end{subfigure}
  \caption{}
...
% \begin{figure}
%   \center
%   \includegraphics[width=0.5\textwidth]{TBurner0000.png}
...
% \begin{figure}
%   \center
%   \includegraphics[width=0.5\textwidth]{TBurner0001.png}
...
% \begin{figure}
%   \center
%   \includegraphics[width=0.5\textwidth]{TBurner0002.png}
...
\begin{figure}[htb!]
  ...
  \begin{subfigure}[b]{0.25\textwidth}
    \includegraphics[width=\textwidth]{TBurner0000.png}
    \caption{Time 1: Oscillatory behavior in the form of a pressure wave in a T-Burner.  Contour plot depicts pressure}
    \label{figtburn1}
  \end{subfigure}

  \begin{subfigure}[b]{0.25\textwidth}
    \includegraphics[width=\textwidth]{TBurner0001.png}
    \caption{Time 2: Oscillatory behavior in the form of a pressure wave in a T-Burner.  Contour plot depicts pressure}
    \label{figtburn2}
  \end{subfigure}

  \begin{subfigure}[b]{0.25\textwidth}
    \includegraphics[width=\textwidth]{TBurner0002.png}
    \caption{Time 3: Oscillatory behavior in the form of a pressure wave in a T-Burner.  Contour plot depicts pressure}
    \label{figtburn3}
  \end{subfigure}

  \begin{subfigure}[b]{0.25\textwidth}
    \includegraphics[width=\textwidth]{TBurnerVel0000.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{pinWheel.png}
