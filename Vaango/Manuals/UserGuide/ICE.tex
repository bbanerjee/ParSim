...
%
\begin{figure}
  \includegraphics[width=0.5\textwidth]{Poiseuille.png}
...
%
\begin{figure}
  \includegraphics[width=0.5\textwidth]{Couette-Poiseuille.png}
  \vspace{-20pt}
  \caption{ Comparison of $u$ velocity $t = 15sec$}
...
%
\begin{figure}
  \includegraphics[width=0.5\textwidth5]{shockTube.png}
...
\begin{figure}
  \includegraphics[width=0.5\textwidth]{shockTube_AMR.png}
  \vspace{-10pt}
  \caption{Shock tube results at time $t = 5msec$}
...
\begin{figure}
  \includegraphics[width=0.5\textwidth]{riemann2D.png}
...
%\newpage
\begin{figure}
 \includegraphics[width=0.5\textwidth]{explode_press.png}
...
%\newpage
\begin{figure}
  \includegraphics[width=0.5\textwidth]{explode_rho.png}
...
%
\begin{figure}
  \includegraphics[width=0.5\textwidth]{explode_1D.png}
  \caption{$t=0.25$}
  \label{fig:1dExplode}
\end{figure}
\newpage
...
\begin{figure}
 \includegraphics[width=0.5\textwidth]{RateStick.png}
...
%doman.  
%\begin{figure}
%\includegraphics[width=0.5\textwidth]{3DFire.png}
