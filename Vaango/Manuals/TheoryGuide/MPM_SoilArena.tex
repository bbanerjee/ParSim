\chapter{Arena: Partially Saturated Soils}

{\Red \bf For a more detailed description and a sample of the input file format, please see
the manual in the \textsf{ArenaSoil} directory.}
...
by the partially saturated version of Arena does not have this limit.  Therefore the trial stress
