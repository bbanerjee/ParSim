...
\begin{document}
  ...
  \begingroup
    ...
    \vspace*{1cm}
    {\Large \textcolor{white}{The Utah Vaango team}}\par % Author name
...
\Visit 10.2 works with the \Vaango code.
\end{WarningBox}
...
\begin{itemize}
  \item You will need a C++ compiler, either \Textsfc{g++} or \Textsfc{clang}:
\begin{lstlisting}[backgroundcolor=\color{background}]
...
\end{lstlisting}
  ...
  \item The Peridynamics code uses parts of the \Textsfc{Eigen3} library. You will have to install 
