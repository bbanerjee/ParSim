...
function table_yield_closest_computed()
  ...
  plot(ZRTable(:,1), ZRTable(:,2), 'c.-', 'LineWidth', 1); hold on;
  axis equal
  ...
  plot(ZRSpline(:,1), ZRSpline(:,2), 'r-', 'LineWidth', 2);
  plot([ZRPoint(1) ZRClose(1)], [ZRPoint(2) ZRClose(2)], 'r-', 'LineWidth', 2); 
  ...
  plot(ZRSpline(:,1), ZRSpline(:,2), 'g-', 'LineWidth', 2);
  plot([ZRPoint(1) ZRClose(1)], [ZRPoint(2) ZRClose(2)], 'g-', 'LineWidth', 2); 
  ...
  ZRClose = [8.66025 0 0];
  plot(ZRSpline(:,1), ZRSpline(:,2), 'b-', 'LineWidth', 2);
  plot([ZRPoint(1) ZRClose(1)], [ZRPoint(2) ZRClose(2)], 'b-', 'LineWidth', 2); 
  ...
  plot(ZRSpline(:,1), ZRSpline(:,2), 'm-', 'LineWidth', 2);
  plot([ZRPoint(1) ZRClose(1)], [ZRPoint(2) ZRClose(2)], 'm-', 'LineWidth', 2); 
  ...
  plot(ZRSpline(:,1), ZRSpline(:,2), 'k-', 'LineWidth', 2);
  plot([ZRPoint(1) ZRClose(1)], [ZRPoint(2) ZRClose(2)], 'k-', 'LineWidth', 2); 
end
