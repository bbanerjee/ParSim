...
public:
  ...
  static ProblemSpecP createInput() {
    ...
    xmlNewChild(meta, nullptr, BAD_CAST "title", BAD_CAST "Unit test neural net Tabular Plasticity");
    ...
    xmlNewChild(da, nullptr, BAD_CAST "filebase", BAD_CAST "UniaxialStrainRotateNNTabularPlasticity.uda");
    ...
    xmlNewChild(elastic, nullptr, BAD_CAST "min_strain",
                BAD_CAST "0.0");
    xmlNewChild(elastic, nullptr, BAD_CAST "max_strain",
                BAD_CAST "0.452");
    xmlNewChild(elastic, nullptr, BAD_CAST "min_pressure",
                BAD_CAST "0.0");
    xmlNewChild(elastic, nullptr, BAD_CAST "max_pressure",
                BAD_CAST "1.0e6");
