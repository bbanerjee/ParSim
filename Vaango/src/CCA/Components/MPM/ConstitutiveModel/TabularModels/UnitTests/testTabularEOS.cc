...
public:
  ...
  createInput()
  {
    ...
    xmlNewChild(
      meta, nullptr, BAD_CAST "title", BAD_CAST "Unit test Tabular EOS");
    ...
    xmlNewChild(da,
                nullptr,
                BAD_CAST "filebase",
                BAD_CAST "HydrostaticCompressionTabular.uda");
    ...
    std::string prescribed = std::string(currPath) + "/" +
                             "HydrostaticCompression_PrescribedDeformation.inp";
    ...
    xmlNewChild(
      cm, nullptr, BAD_CAST "independent_variables", BAD_CAST "DensityRatio");
    xmlNewChild(
    ...
    std::string ups_file =
      std::string(currPath) + "/" + "HydrostaticCompressionTabular.ups";
...
TEST(TabularEOSTest, singleParticleTest)
{
  ...
  // Remove existing uda
  std::string uda_file =
    std::string(currPath) + "/" + "HydrostaticCompressionTabular.uda.000";
