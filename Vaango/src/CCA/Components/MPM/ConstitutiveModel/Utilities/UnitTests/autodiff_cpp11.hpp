...
auto make_fvar_for_tuple(boost::mp11::index_sequence<Is...>, RealType const& ca)
...
auto make_ftuple_impl(boost::mp11::index_sequence<Is...>, RealTypes const&... ca)
    -> decltype(std::make_tuple(make_fvar_for_tuple<RealType, Orders>(boost::mp11::make_index_sequence<Is>{},
                                                                      ca)...)) {
  return std::make_tuple(make_fvar_for_tuple<RealType, Orders>(boost::mp11::make_index_sequence<Is>{}, ca)...);
}
...
auto make_ftuple(RealTypes const&... ca)
    -> decltype(detail::make_ftuple_impl<RealType, Orders...>(boost::mp11::index_sequence_for<RealTypes...>{},
                                                              ca...)) {
  static_assert(sizeof...(Orders) == sizeof...(RealTypes),
                "Number of Orders must match number of function parameters.");
  return detail::make_ftuple_impl<RealType, Orders...>(boost::mp11::index_sequence_for<RealTypes...>{}, ca...);
}
