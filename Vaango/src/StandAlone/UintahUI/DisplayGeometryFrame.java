//**************************************************************************
// Program : DisplayGeometryFrame.java
...
// Essential data
  ...
  public DisplayGeometryFrame(ParticleList partList,
    ...
    d_parent = parent;
    d_domainSize = parent.getDomainSize();
  ...
  protected class PlaneCanvas extends LightWeightCanvas {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2685836938176311249L;
	// Data
    int d_type = 0;
    ...
    private void drawRule(Graphics g) {
      ...
      double sizeIncr = d_domainSize/10.0;
  ...
  private final class TopCanvas extends PlaneCanvas {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3316802860377428495L;
    ...
    private void drawCircles(Graphics g, int size) {
      ...
      for (int ii = 0; ii < size; ii++) {
        ...
        g.drawOval(xCentScreen-radXScreen,yCentScreen-radYScreen,
                   2*radXScreen, 2*radYScreen);
        g.drawString(String.valueOf(ii),xCentScreen,yCentScreen);
      }
    }
    ...
    private boolean circleIsOutsideRVE(double rad, double xCent, double yCent) {
      double distXPlus = d_domainSize - (xCent-rad);
  ...
  private final class SideCanvas extends PlaneCanvas {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -707348317398414842L;
  ...
  private final class FrontCanvas extends PlaneCanvas {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3140329813221024915L;

	//-------------------------------------------------------------------------
    // Constructor
    //-------------------------------------------------------------------------
    public FrontCanvas(int width, int height) {
      super(width,height,DisplayGeometryFrame.FRONT);
      initialize();
    }
