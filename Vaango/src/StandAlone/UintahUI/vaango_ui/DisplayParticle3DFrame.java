...
public class DisplayParticle3DFrame extends JFrame {
  ...
  private class DisplayParticle3DPanel extends JPanel {
    ...
    private void initialize()
    {
      ...
      // Create a bounding sphere for the view
      ...
      modelClip.setInfluencingBounds(bound_sph);
      boolean enables[] = {true, true, true, true, true, true}; 
      modelClip.setEnables(enables);  
      modelClip.setPlane(0, new Vector4d(1.0, 0.0, 0.0, -1.01));
      modelClip.setPlane(1, new Vector4d(-1.0, 0.0, 0.0, -1.01));
      modelClip.setPlane(2, new Vector4d(0.0, 1.0, 0.0, -1.01));
      modelClip.setPlane(3, new Vector4d(0.0, -1.0, 0.0, -1.01));
    ...
    private BranchGroup createSphere(double radius, double xcent, double ycent, double zcent) {
      ...
      Sphere sphere = new Sphere((float) radius, 1, 50, appear);
      TransformGroup tg = new TransformGroup();
      Transform3D transform = new Transform3D();
