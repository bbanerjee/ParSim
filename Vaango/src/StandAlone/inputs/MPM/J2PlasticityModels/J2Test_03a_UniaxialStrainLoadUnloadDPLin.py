...
def uniaxialStrainLoadUnloadDPLin(uda_path, save_path,**kwargs):
  print("Post Processing Test: 03 - Uniaxial Compression With Load-Unload Linear Drucker-Prager")
  ...
  savePNG(save_path+'/UniaxialStrainLoadUnloadDPLin_sigma_time','1280x960')
  ...
  savePNG(save_path+'/UniaxialStrainLoadUnloadDPLin_pq_time','1280x960')
