...
ShowAllWindows()
RestoreSession("/home/banerjee/ParSim/Matiti/runs/RigidHullSims/vroundhull_local_upd.session", 0)
...
for time_cycle in range(1,21):
  ...
  SaveWindowAtts.fileName = "RigidCentrifuge_Full_RoundHull_NoWalls"+'%.4d'%time_cycle
