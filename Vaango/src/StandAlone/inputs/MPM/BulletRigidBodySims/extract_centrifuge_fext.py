...
def main(argv):
  ...
  parser = argparse.ArgumentParser(
    usage="extract_centrifuge_fext --plane <x0> <y0> <z0> <x1> <y1> <z1> <x2> <y2> <z2> --surf_area <area> --mat <mat id> --tlo <int timestep low> --thi <int timestep hi> --tstep <int stepsize> --uda <uda name>")
