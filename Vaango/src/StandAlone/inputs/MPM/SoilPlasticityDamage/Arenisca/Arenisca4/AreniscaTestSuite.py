...
default_inputs_path = uintah_src_path+'/StandAlone/inputs/MPM/Arenisca/Arenisca4/'
default_working_dir = uintah_src_path+'/StandAlone/inputs/MPM/Arenisca/Arenisca4/test_run'
