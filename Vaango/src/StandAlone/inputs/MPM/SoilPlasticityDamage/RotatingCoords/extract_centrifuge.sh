...
#./extract_centrifuge_bulge.py --mat 0 --box -0.575 -0.0 0.20 1.15 0.01 0.01 --tlo 0 --thi 140 --tstep 10 --uda Centrifuge_AGR_SimPBC_dense_layer_very_lores_drained.uda.000
./extract_centrifuge_bulge.py --mat 0 --box -0.575 -0.0 0.20 1.15 0.01 0.01 --tlo 0 --thi 112 --tstep 10 --uda Centrifuge_AGR_SimPBC_dense_layer_very_lores_saturated.uda.000
