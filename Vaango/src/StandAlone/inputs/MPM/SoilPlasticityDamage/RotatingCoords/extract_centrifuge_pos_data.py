...
def main(argv):
  ...
  parser = argparse.ArgumentParser(
    usage="extract_centrifuge_pos_data --box xmin ymin zmin dx dy dz --mat <mat id> --timestep <int> --uda <uda file_name_prefix>")
...
#   export EXTRACTPOS_EXE=/home/..../extractPosVelMasVol
#--------------------------------------------------------------------------
def set_execs_and_dirs():
  ...
  if (os.getenv('EXTRACTPOS_EXE') == None):
    print "**ERROR** Missing environment var. In bash: export EXTRACTPOS_EXE=/path/to/extractPosVelMasVol"
    sys.exit()
