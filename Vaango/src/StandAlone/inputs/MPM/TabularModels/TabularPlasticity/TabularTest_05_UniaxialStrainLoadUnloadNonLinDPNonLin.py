...
def uniaxialStrainLoadUnloadNonLinDPNonLin(uda_path, save_path,**kwargs):
  print("Post Processing Test: 05 - Uniaxial Compression NL DP With Loading and Unloading")
  ...
  savePNG(save_path+'/UniaxialStrainLoadUnloadNonLinDPNonLin_sigma_eps','1280x960')
  ...
  savePNG(save_path+'/UniaxialStrainLoadUnloadNonLinDPNonLin_yield_surface','1280x960')
  #plt.show()
  ...
  plt.grid(True)
  plt.legend(loc='best', prop={'size':10}) 
  savePNG(save_path+'/UniaxialStrainLoadUnloadNonLinDPNonLin_sigma_time','1280x960')
  ...
  savePNG(save_path+'/UniaxialStrainLoadUnloadNonLinDPNonLin_pq_time','1280x960')
