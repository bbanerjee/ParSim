...
def uniaxialStrainRotate(uda_path, save_path,**kwargs):
  print("Post Processing Test: 10 - Uniaxial Compression With Rotation")
  ...
  savePNG(save_path+'/UniaxialStrainRotate_sigma_rot_time','1280x960')
  ...
  savePNG(save_path+'/UniaxialStrainRotate_yield_surface','1280x960')
  #plt.show()
