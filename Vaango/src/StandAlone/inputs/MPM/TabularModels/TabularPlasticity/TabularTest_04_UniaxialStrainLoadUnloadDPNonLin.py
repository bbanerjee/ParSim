...
def uniaxialStrainLoadUnloadDPNonLin(uda_path, save_path,**kwargs):
  ...
  savePNG(save_path+'/UniaxialStrainLoadUnloadDPNonLin_sigma_eps','1280x960')
  ...
  savePNG(save_path+'/UniaxialStrainLoadUnloadDPNonLin_yield_surface','1280x960')
  #plt.show()
  ...
  plt.grid(True)
  plt.legend(loc='best', prop={'size':10}) 
  savePNG(save_path+'/UniaxialStrainLoadUnloadDPNonLin_sigma_time','1280x960')
  ...
  savePNG(save_path+'/UniaxialStrainLoadUnloadDPNonLin_pq_time','1280x960')
