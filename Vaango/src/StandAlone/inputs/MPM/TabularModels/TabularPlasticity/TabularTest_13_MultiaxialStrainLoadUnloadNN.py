...
def multiaxialStrainLoadUnloadNN(uda_path, save_path,**kwargs):
  print("Post Processing Test: 13 - Multi-axial Loading and Unloading (NN)")
  ...
  savePNG(save_path+'/MultiaxialStrainLoadUnloadNN_sigma_time','1280x960')
  ...
  plt.grid(True)
  plt.legend(loc='best', prop={'size':10}) 
  savePNG(save_path+'/MultiaxialStrainLoadUnloadNN_pbar_evbar','1280x960')
  #plt.show()
  ...
  savePNG(save_path+'/MultiaxialStrainLoadUnloadNN_pq_time','1280x960')
