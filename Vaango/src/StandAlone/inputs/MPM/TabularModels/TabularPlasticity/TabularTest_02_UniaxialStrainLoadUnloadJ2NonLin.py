...
def uniaxialStrainLoadUnloadJ2NonLin(uda_path, save_path,**kwargs):
  print("Post Processing Test: 02 - Uniaxial Compression With Loading and Unloading")
  ...
  ev_e_list, ev_p_list, times_list, ev_e_sim, ev_p_sim = getInternalVariables(uda_path, analytical_times)
  ...
  plotSimDataSigmaEps(fig1, analytical_times, times, pp_sim, ev_e_sim, ev_p_sim)
  ...
  savePNG(save_path+'/UniaxialStrainLoadUnloadJ2NonLin_sigma_eps','1280x960')
  ...
  savePNG(save_path+'/UniaxialStrainLoadUnloadJ2NonLin_yield_surface','1280x960')
  #plt.show()
  ...
  plt.grid(True)
  plt.legend(loc='best', prop={'size':10}) 
  savePNG(save_path+'/UniaxialStrainLoadUnloadJ2NonLin_sigma_time','1280x960')
  ...
  savePNG(save_path+'/UniaxialStrainLoadUnloadJ2NonLin_pq_time','1280x960')
