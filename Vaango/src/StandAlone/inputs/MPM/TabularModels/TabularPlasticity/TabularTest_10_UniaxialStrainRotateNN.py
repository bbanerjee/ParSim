...
def uniaxialStrainRotateNN(uda_path, save_path,**kwargs):
  print("Post Processing Test: 10 - Uniaxial Compression With Rotation (NN)")
  ...
  plt.grid(True)
  plt.legend(loc='best', prop={'size':10}) 
  savePNG(save_path+'/UniaxialStrainRotateNN_sigma_time','1280x960')
  ...
  plt.grid(True)
  plt.legend(loc='best', prop={'size':10}) 
  savePNG(save_path+'/UniaxialStrainRotateNN_pbar_evbar','1280x960')
  #plt.show()
  ...
  savePNG(save_path+'/UniaxialStrainRotateNN_pq_time','1280x960')
