...
def uniaxialStrainTensionNN(uda_path, save_path,**kwargs):
  print("Post Processing Test: 09 - Uniaxial strain tension (NN)")
  ...
  savePNG(save_path+'/UniaxialStrainTensionNN_yield_surface','1280x960')
  #plt.show()
  ...
  savePNG(save_path+'/UniaxialStrainTensionNN_pq_time','1280x960')
