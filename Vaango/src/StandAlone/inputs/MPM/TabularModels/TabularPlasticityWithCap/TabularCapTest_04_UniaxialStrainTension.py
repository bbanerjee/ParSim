...
def uniaxialStrainTension(uda_path, save_path,**kwargs):
  print("Post Processing Test: 04 - Uniaxial strain tension")
  ...
  savePNG(save_path+'/UniaxialStrainTension_yield_surface','1280x960')
  #plt.show()
  ...
  savePNG(save_path+'/UniaxialStrainTension_sigma_time','1280x960')
  ...
  plt.grid(True)
  plt.legend(loc='best', prop={'size':10}) 
  savePNG(save_path+'/UniaxialStrainTension_pbar_evbar','1280x960')
  #plt.show()
  ...
  savePNG(save_path+'/UniaxialStrainTension_pq_time','1280x960')
