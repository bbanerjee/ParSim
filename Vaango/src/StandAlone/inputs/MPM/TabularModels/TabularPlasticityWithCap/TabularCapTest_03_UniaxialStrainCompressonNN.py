...
def uniaxialStrainCompressionNN(uda_path, save_path,**kwargs):
  print("Post Processing Test: 03 - Uniaxial Compression (NN)")
  ...
  savePNG(save_path+'/UniaxialStrainCompressionNN_yield_surface','1280x960')
  #plt.show()
  ...
  savePNG(save_path+'/UniaxialStrainCompressionNN_sigma_time','1280x960')
  ...
  plt.grid(True)
  plt.legend(loc='best', prop={'size':10}) 
  savePNG(save_path+'/UniaxialStrainCompressionNN_pbar_evbar','1280x960')
  #plt.show()
  ...
  savePNG(save_path+'/UniaxialStrainCompressionNN_pq_time','1280x960')
