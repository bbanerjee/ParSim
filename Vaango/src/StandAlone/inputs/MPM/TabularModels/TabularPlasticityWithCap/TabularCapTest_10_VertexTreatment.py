...
def analyticalSolutionHomel(compression):

  times = [0, 1, 1.5, 2.0, 2.5, 3.0, 25/7, 4, 5]
  S11 = np.array([0,
                  -850.0/3.0,
...
def vertexTreatmentHomel(uda_path, save_path,**kwargs):
  ...
  analytical_times, analytical_S11, analytical_S22, analytical_S33, \
    ...
    = analyticalSolutionHomel(compression)
