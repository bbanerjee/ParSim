...
# Simplify the combine dataframes and remove duplicates (if any)
data_00_all = data_00_all[['TotalStrainVol', 'Pressure']].copy().drop_duplicates()
data_09_all = data_09_all[['TotalStrainVol', 'Pressure']].copy().drop_duplicates()
data_18_all = data_18_all[['TotalStrainVol', 'Pressure']].copy().drop_duplicates()
data_27_all = data_27_all[['TotalStrainVol', 'Pressure']].copy().drop_duplicates()
data_36_all = data_36_all[['TotalStrainVol', 'Pressure']].copy().drop_duplicates()
data_45_all = data_45_all[['TotalStrainVol', 'Pressure']].copy().drop_duplicates()
...
with open('DrySand_ElasticData_Tension.json', 'w') as outputFile:
