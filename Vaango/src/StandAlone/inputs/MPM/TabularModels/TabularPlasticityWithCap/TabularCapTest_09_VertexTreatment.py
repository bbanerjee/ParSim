...
def analyticalSolution(compression):

  times = [0, 1, 1.5, 2.0, 2.5, 3.0]
  S11 = np.array([0,
                  -850.0/3.0,
...
def vertexTreatment(uda_path, save_path,**kwargs):
  print("Post Processing Test: 09 - Vertex treatment")
  ...
  analytical_times, analytical_S11, analytical_S22, analytical_S33, \
    ...
    = analyticalSolution(compression)
  ...
  savePNG(save_path+'/VertexTreatment_yield_surface','1280x960')
  #plt.show()
  ...
  savePNG(save_path+'/VertexTreatment_sigma_time','1280x960')
  ...
  plt.grid(True)
  plt.legend(loc='best', prop={'size':10}) 
  savePNG(save_path+'/VertexTreatment_pbar_evbar','1280x960')
  #plt.show()
  ...
  savePNG(save_path+'/VertexTreatment_pq_time','1280x960')
