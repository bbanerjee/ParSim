...
../extractPvec -m 0 -partvar p.displacement -p UniaxialStrainMMS_part.dat -uda UniaxialStrain_MMS.uda.000 -o UniaxialStrainMMS_pDisplacement.dat -timefiles
...
#../extractPvec -m 0 -partvar p.displacement -p UniaxialStrainMMS_part.dat -uda UniaxialStrain_MMS_pvelBC.uda.000 -o UniaxialStrainMMS_pDisplacement.dat -timefiles
...
#../extractPvec -m 0 -partvar p.displacement -p UniaxialStrainMMSHomoLin_part.dat -uda UniaxialStrainHomoLin_MMS.uda.000 -o UniaxialStrainMMSHomoLin_pDisplacement.dat -timefiles
...
#../extractPvec -m 0 -partvar p.displacement -p UniaxialStrainMMSHomoQuad_part.dat -uda UniaxialStrainHomoQuad_MMS.uda.000 -o UniaxialStrainMMSHomoQuad_pDisplacement.dat -timefiles
