...
default_inputs_path = uintah_src_path+'/StandAlone/inputs/MPM/Arenisca/Arenisca3_undrained/'
default_working_dir = uintah_src_path+'/StandAlone/inputs/MPM/Arenisca/Arenisca3_undrained/test_run'
