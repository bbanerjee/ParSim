...
default_inputs_path = uintah_src_path+'/StandAlone/inputs/MPM/Arenisca/Arenisca3_DrySand/'
default_working_dir = uintah_src_path+'/StandAlone/inputs/MPM/Arenisca/Arenisca3_DrySand/test_run'
