...
default_inputs_path = uintah_src_path+'/StandAlone/inputs/MPM/Arenisca/Arenisca3_drained/'
default_working_dir = uintah_src_path+'/StandAlone/inputs/MPM/Arenisca/Arenisca3_drained/test_run'
